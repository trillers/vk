...
Bot.prototype.offAgentStatusChange = function(){
    this.removeAllListeners(messageDefinitions.bot.clientAgentStatusChange.eventName + this.id);
};

Bot.prototype.onAgentStatusChange = function(handler){
    this.on(messageDefinitions.bot.clientAgentStatusChange.eventName + this.id, handler);
};
